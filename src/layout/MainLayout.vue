            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://sushifortal.com.br/" class="flex items-center">
                        <img src="../assets/images/logo.jpeg" class="h-12 mr-3 rounded-full" alt="FlowBite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap">Sushi Fortal</span>
                    </a>
                </div>
            </div>
            <hr class="my-6 border-gray-200 sm:mx-auto lg:my-8" />
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center ">© 2023 <a href="https://sushifortal.com.br/"
